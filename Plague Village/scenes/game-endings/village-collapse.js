...
villageCollapseScene.innerHTML = `
    <img id="villageCollapseBackground" src="images/backgrounds/village_collapse.png" alt="Village Collapse Background">

    <img id="villageCollapseDoctorSprite" src="images/characters/plagueDoctor1.png" alt="Plague Doctor">
