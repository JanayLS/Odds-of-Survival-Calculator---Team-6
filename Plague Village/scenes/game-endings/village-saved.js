...
villageSavedScene.innerHTML = `
    <img id="villageSavedBackground" src="images/backgrounds/village_saved.png" alt="Village Saved Background">

    <img id="villageSavedDoctorSprite" src="images/characters/plagueDoctorSaved.png" alt="Plague Doctor">
