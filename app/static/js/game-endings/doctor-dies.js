...
doctorDiesScene.innerHTML = `
    <img id="doctorDiesBackground" src="/static/img/backgrounds/toxicVillage.png" alt="Toxic Village Background">

    <img id="doctorDiesSprite" src="/static/img/characters/plagueDoctor1.png" alt="Plague Doctor">
...
(function initializeDoctorDiesScene() {
    ...
    const doctorDiesPoseImages = {
        normal: "/static/img/characters/plagueDoctor1.png",
        loss: "/static/img/characters/plagueDoctor_loss.png",
        unbalanced: "/static/img/characters/plagueDoctor_unbalanced.png",
        falling: "/static/img/characters/plagueDoctor_falling.png",
        dead: "/static/img/characters/plagueDoctor_dead.png"
    };
